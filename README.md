...
The system leverages QED vacuum polarization, where strong opposing magnetic fields (B_opposing >20 T; depends upon mass, with some B_opposing >60-90+ T) disrupt virtual electron-positron pairs, inducing diamagnetic repulsion for propulsion.  Based on Heisenberg-Euler-Schwinger effective action at 0.1-1 MHz frequencies, it achieves thrust via F ∝ χ B² ∇(h²) A ρ. 
