...
- **Spin-2 Emergent Gravity**: The old version of EFDPP; the relevant modifier equation is provided for testing, but neither old nor new modifiers are necessary if an experimentally derived modifier is desired/provided
